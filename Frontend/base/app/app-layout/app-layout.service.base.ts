...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"outline":false,"infiniteScroll":false,"urlIconFileName":"Company Logo.svg","valueChange":true,"logoFileName":"Company Logo.svg","currentNode":"add5918c-d9c6-4506-8c3a-250024394ad8","mobileLogoFileName":"Company Logo.svg","element":"logo"},{"outline":false,"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"outline":false,"element":"appTitle"}],"middle":[{"outline":false,"element":"leftPane"},{"outline":false,"element":"middlePane"},{"outline":false,"element":"rightPane"}],"right":[{"outline":false,"menuType":"float","element":"rightMenu"},{"children":[{"outline":false,"link":"/logout","label":"Logout","element":"logout"}],"element":"user"}]};
