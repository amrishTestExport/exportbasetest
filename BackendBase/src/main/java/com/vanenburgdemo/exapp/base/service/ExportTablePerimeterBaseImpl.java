...
import com.vanenburgdemo.exapp.base.model.constants.ExportTableConstantBase;
...
@Component
public abstract class ExportTablePerimeterBaseImpl<T extends ExportTableBase> implements IPerimeterManager<T>, ExportTableConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(ExportTablePerimeterBaseImpl.class);
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase == null) {
			...
			String[] readFields = new String[] {SID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, SYNC_TIME, TABLE1, NAME, DEPARTMENT, SEQUENCE};
